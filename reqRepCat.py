...
def getUsers():
     con = sqlite3.connect("requirements.db") 
     cur = con.cursor()  
     cur.execute("SELECT UserId, UserNo, PassWord from User")  
              ...
              with hd.form( ) as form:    
                        ...
                        if form.submitted:  
                            if len(ErrorArray) == 0:   
                                ...
                                UpdateUser(listvalues[0][index], listvalues[1][index],listvalues[2][index] )         
                      ...
                      if len(ErrorArray) == 0:
                            ...
                            for i in range(1, len(listkeys)):
                                with hd.scope(i):
                                    ...
                                    datatabledict.update({listkeys[i]:listvalues[i]}) 
                            insertUser(maxid,form.form_data[listkeys[1]], form.form_data[listkeys[2]])
